...
<!--                    <p>
                    ...
                    <form:form class="form-light mt-20" modelAttribute="contactBean" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" id="contact_phone" name="contact_phone" class="form-control" value="<c:out value="${contactbyId.contact_phone}"></c:out>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
